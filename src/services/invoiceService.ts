...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .info-block { flex: 1; }
    .info-block h3 { font-size: 12px; text-transform: uppercase; letter-spacing: 1px; color: #94A3B8; margin-bottom: 8px; font-weight: 600; }
    ...
    .details-table .description { color: #94A3B8; font-size: 13px; margin-top: 4px; }
...
<body>
  <div class="invoice-header">
    <div>
      <div class="company-name">${escapeHtml(invoice.cleanerCompanyName)}</div>
      <p style="font-size:13px;color:#94A3B8;">Professional Cleaning Services</p>
    </div>
    <div>
  ...
  <div class="info-section">
    <div class="info-block">
      ...
      <p>${escapeHtml(invoice.cleanerCompanyName)}</p>
    </div>
  ...
  <div class="footer">
    ...
    <p style="margin-top:4px;">Generated by Cleaner Choice</p>
  </div>
</body>
</html>`;
};
