...
//     order : require('../assets/images/box.png'),
//     settings : require('../assets/images/setting.png'),
//     vehicle : require('../assets/images/vehicles.png'),
//     profile : require('../assets/images/profile.png'),
//     orderActive :  require('../assets/images/order-active.png'),
//     settingActive :  require('../assets/images/setting-active.png'),
//     vehicleActive :  require('../assets/images/vehicle-active.png'),
