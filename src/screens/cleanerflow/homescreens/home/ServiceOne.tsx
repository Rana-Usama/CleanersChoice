        ...
        <View style={styles.container}>
          ...
          <View style={styles.dateContainer}>
            <TouchableOpacity onPress={() => setOpen(true)} style={styles.dateButton}>
              <Image source={Icons.calendar} resizeMode="contain" style={styles.dateIcon} />
          ...
          <CustomDropDown placeholder="Select services you provide" />
  
          <View style={styles.buttonContainer}>
            <GradientButton title="Next" onPress={()=>navigation.navigate('ServiceTwo')} />
          </View>
        </View>
      </SafeAreaView>
    );
